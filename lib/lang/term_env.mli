...
val empty : unit -> t
val introduce : t -> id:Var_ident.t -> sc:Scheme.t -> t
val lookup : t -> id:Var_ident.t -> Scheme.t Option.t
val map : t -> f:(Scheme.t -> Scheme.t) -> t
val free_tvars : t -> (Type_var.t, Type_var.comparator_witness) Set.t
val merge : t -> t -> f:(key:Var_ident.t -> Merge_element.t -> Scheme.t Option.t) -> t
val size : t -> int
